...
public class Nomina {
	...
	//constructores
	Nomina(){};
	Nomina(float sb,float cs,float he,float pe,float se, float noSal, String mes, boolean fuerzaMayor, boolean pagaExtra, float dinero){
		this.mes=mes;
		this.sb=sb;
		this.cs=cs;
		this.he=he;
